#copied the code in Activity.py
...
#    print("Post-order traversal:", letter_tree.post_order_traversal(),"\n")
    ...
    numbers = [18, 17, 4, 1, 9, 20, 25, 88, 101, 55] 
    numbers_tree = build_tree(numbers)
    numbers_tree.delete(20)
    print("New Set of Elements:")
    print(numbers)
    print("\nAfter deleting 20 (In order) ",numbers_tree.in_order_traversal()) 
    print("\nAfter deleting 20 (Pre order) ",numbers_tree.pre_order_traversal()) 
    print("\nAfter deleting 20 (Post order) ",numbers_tree.post_order_traversal()) 
